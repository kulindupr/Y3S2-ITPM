...
import './AiAssistant.css'; // Assuming you have a CSS file for styles
                    ...
                    {currentHistory.length === 0 && (
                        <div className="chat-welcome" style={{ width: '100%', height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                            <div className="assistant-illustration">
                                <img src={assets.linky} alt="Linky, the AI Intern Buddy" style={{ width: 600, maxWidth: '90vw', height: 'auto', display: 'block' }} />
                            </div>
                        </div>
                    )}
