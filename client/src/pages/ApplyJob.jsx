    ...
    <>
      ...
      <div className="max-w-4xl mx-auto my-8 p-6 bg-blue-100 rounded-2xl shadow-lg">
        ...
        <div className="flex justify-between items-center mt-6">
          <button
            onClick={handleApply}
            className="cursor-pointer bg-blue-500 text-white px-6 py-2 rounded-lg font-medium border-2 border-blue-500 transition-all duration-300 hover:bg-transparent hover:text-blue-500"
          >
            Apply Now
          </button>
      ...
      {/* Internship Description + More Jobs */}
      <div className='container px-4 2xl:px-20 mx-auto flex justify-between items-center'>
        <div className='flex flex-col lg:flex-row justify-between items-start'>
          <div className='w-full lg:w-2/3'>
            ...
            <button
              onClick={handleApply}
              className="cursor-pointer bg-blue-500 text-white px-6 py-2 rounded-lg font-medium border-2 border-blue-500 transition-all duration-300 hover:bg-transparent hover:text-blue-500 mt-10"
            >
              Apply Now
            </button>
          </div>
